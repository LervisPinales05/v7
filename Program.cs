    ...
    class Program
    {
        ...
        {  
           ...
           while(next){
               ...
               Console.WriteLine("4 - Buscar por Cedula");
               Console.WriteLine("5 - Editar por Cedula");
        ...
        public static string Information(string id = null){
            ...
            Console.Write("\nFavor Digite un Nombre: ");
            string name = Console.ReadLine();
            Console.Write("Favor Digite un Apellido: ");
            string lastName = Console.ReadLine();                           
            Console.Write("Favor Colocar sus Ahorros: ");
        ...
        public static void Search(){
            ...
            if (per == null)
            {
                ...
                Console.WriteLine("Esta persona no se encuestra!!");
        ...
        public static void Edit(){
            ...
            Console.Write("Favor Digitar una Cedula: ");
            string id = yearsOldC(32);
            Console.WriteLine();
